...
# This script builds the variable from the official NBER chronology, which is different
# from the technical rule of two-consecutive-recessionary-quarters we implemented. This is the variable our ad data is matched against.
...
# It is data construction and measurement. No models are fitted here. We make here a measurement comparison, not a model.
